...
The median number of sports balls collected in the year 2017 was *`r median(pull(mtw, sports_balls))`*. The amount of trash collected is known to be a function of the amount of rainfall. The average precipitation from Jan-July 2017 was *`r mean(pull(rain_2017, Total))`*, and from Jan-July 2018 it was *`r mean(pull(rain_2018, Total))`*. The average amount of trash collected from Jan-Nov 2017 was *`r mean(pull(wt_2017, weight_tons))`* tons, and from Jan-July 2018 was *`r mean(pull(wt_2018, weight_tons))`* tons. This data suggests that the increased average rainfall in 2018 also led to an increase in the amount of trash collected compared to 2017.
